...
window = sg.Window('                            VISUAL INSPECTION                      ', layout, size=(1200, 800), margins=(1, 1),titlebar_font=('Times New Roman',28),titlebar_background_color="white",
                   titlebar_text_color="green",titlebar_icon="logo.png",use_custom_titlebar=True,auto_size_buttons=True)
